...
public class calcula extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<h3>Nombre del empleado: " + nombre + "</h3>");
            out.println("<h3>Salario Bruto: " + importesinIva + "</h3>");
            out.println("<h3>Retencion aplicada: " + tipoIva + "</h3>");
            out.println("<h3>Salario neto: " + precioConIva + "</h3>");
            out.println("</body>");
            out.println("</html>");
